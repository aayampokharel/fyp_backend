...
var (
	...
	ErrVerifyingBlock               = errorz.Status406NotAcceptable.Wrap("block chain verification failed")
	ErrNegativeBlockNumber          = errorz.Status406NotAcceptable.Wrap("Block number cannot be negative")
	ErrDigitalSignature             = errorz.Status406NotAcceptable.Wrap("Digital signature failed")
	ErrConvertToRsa                 = errorz.Status406NotAcceptable.Wrap("convert to rsa key failed")
